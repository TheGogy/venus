...
unsafe extern "C" {
    pub fn ven_tb_knight_attacks(square: ::std::os::raw::c_uint) -> u64;
}
unsafe extern "C" {
    pub fn ven_tb_king_attacks(square: ::std::os::raw::c_uint) -> u64;
}
unsafe extern "C" {
    pub fn ven_tb_rook_attacks(square: ::std::os::raw::c_uint, occ: u64) -> u64;
}
unsafe extern "C" {
    pub fn ven_tb_bishop_attacks(square: ::std::os::raw::c_uint, occ: u64) -> u64;
}
unsafe extern "C" {
    pub fn ven_tb_queen_attacks(square: ::std::os::raw::c_uint, occ: u64) -> u64;
}
unsafe extern "C" {
    pub fn ven_tb_pawn_attacks(square: ::std::os::raw::c_uint, color: bool) -> u64;
}
unsafe extern "C" {
