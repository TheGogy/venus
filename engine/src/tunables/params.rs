...
init_tunables! {
    ...
    ms_base: i32 = 700, 600, 900, 10;
    ms_knight: i32 = 446, 400, 500, 5;
    ms_bishop: i32 = 464, 400, 500, 5;
    ms_rook:   i32 = 705, 600, 800, 10;
    ms_queen:  i32 = 1322, 1200, 1400, 10;

    // Aspiration window.
    asp_window_default: i32 = 25, 10, 30, 1;
    asp_window_d_min:   i16 = 5, 2, 7, 1;

    // History bonuses.
    hist_bonus_max:  i16 = 1600, 800, 3200, 100;
    hist_bonus_base: i16 = 350, 100, 600, 25;
    hist_bonus_mult: i16 = 350, 100, 600, 25;

    // History maluses.
    hist_malus_max:  i16 = 1600, 800, 3200, 100;
    hist_malus_base: i16 = 350, 100, 600, 25;
    hist_malus_mult: i16 = 350, 100, 600, 25;
    ...
    lmr_ver_e_min: i32 = 60, 40, 200, 2;
    lmr_ver_e_depth_scale: i32 = 10, 5, 20, 1;
    ...
    rfp_mult:             i32 = 80, 40, 120, 5;
    rfp_improving_margin: i32 = 55, 25, 85, 5;

    // Null move pruning.
    nmp_d_min:            i16 = 3, 1, 4, 1;
    nmp_improving_margin: i32 = 70, 40, 100, 5;
    nmp_base:             i16 = 4, 2, 7, 1;
    nmp_factor:           i16 = 4, 2, 8, 1;

    // Internal iterative reductions.
    iir_d_min:  i16 = 4, 3, 7, 1;
    ...
    // SEE pruning.
    sp_noisy_margin: i32 = -20, -40, 0, 5;
    sp_quiet_margin: i32 = -65, -120, -30, 5;
    sp_d_min:        i16 = 9, 6, 14, 1;
